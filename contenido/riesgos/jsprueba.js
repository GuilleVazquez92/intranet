window.onload = consultar_puntos();
	...
	function consultar_puntos(){
		...
		var deuda_interna =document.getElementById("deuda_interna").value;
		var total_deuda_in =document.getElementById("total_deuda_in").value;
		capacidad = (ingreso.value*endeudamiento)+ 50000;
		if (capacidad == 50000){
			limite_prestable = 0;
			saldo_cuota = 0;
			saldo_total = 0;
			...
			saldo_cuota = capacidad - deuda_interna;
			saldo_total = limite_prestable - total_deuda_in;
		}
		...
		document.getElementById("saldo_cuota").innerHTML =  format(Math.round(saldo_cuota).toString());
		
		document.getElementById("saldo_total").innerHTML =  format(Math.round(saldo_total).toString());
	}
