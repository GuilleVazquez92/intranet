...
try{
	...
	$resultado = $soapclient->NuevoLote($init);	
	$respuesta = (json_decode(json_encode($resultado), true));

	include('mail_carga_lote.php');
	include('ws_estado_lote.php');	
